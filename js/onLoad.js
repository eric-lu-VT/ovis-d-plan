...
$(function() {
	...
	$('#box_white, #box_black, #dropArea').droppable({
		...
		drop: function(event,ui) {
			...
			if ( (droppedItemID == (finalTerm + "3") || droppedItemID == (finalTerm + "2") || droppedItemID == (finalTerm + "1")) && (droppedItemClass == "R")) {
				console.log("switching seniorYearCheck");
				seniorYearCheck = 1;
				$("#errorText").html("<font color=\"black\">See</font> the Registrar's Office for petition to waive the senior year residency requirement as to this term.");
				$( "#dialog-flex" ).dialog('open');
			}
